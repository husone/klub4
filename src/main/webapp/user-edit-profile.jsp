                                        ...
                                        <div class="card-body mt-2">
                                            ...
                                            <div class="mt-5">
                                                <form action="./UserEditProfile" class="col-12 row mt-5">
                                                    ...
                                                    <div class="form-group col-12 row align-items-center">
                                                        <label class="col-md-4" for="new-name"> <h5>Avatar</h5> </label>
                                                        <h5 id="image-data"></h5>
                                                        <input type="file" id="club-avatar" name="club-avatar" class="col-md-8" onchange="onFileSelected(event)">
                                                        <input name="image-url" id="image-url" style="display: none">
                                                    </div>

                                                    <div class="form-group col-12 row align-items-center">
                                                        <label class="col-md-4" for="new-address"> <h5>Address</h5> </label>
                                                        <input type="text" placeholder="" name="new-address" id=new-address" value="${userData.address}" class="form-control col-md-8">
                                                    </div>

                                                    <div class="form-group col-12 row align-items-center">
                                                        <label class="col-md-4" for="new-DOB"> <h5>Date of birth</h5> </label>
                                                        <input type="date" placeholder="" name="new-DOB" id="new-DOB" value="${userData.dOB}" class="form-control col-md-8">
                                                    </div>
